...
const inputVariants = cva(
  "grow overflow-hidden rounded-md transition items-center outline -outline-offset-1 bg-card text-text-primary disabled:text-text-disabled focus-within:shadow-box pr-lg",
  {
    variants: {
      status: {
